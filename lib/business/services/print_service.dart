...
class BlePrintService implements PrintService {
  ...
  static const String charUuid = "49535343-8841-43f4-a8d4-ecbe34729bb3";
  ...
  Future<void> _conectar() async {
    ...
    for (final d in bonded) {
      if (d.remoteId.toString().toUpperCase() == printerMac.toUpperCase()) {
