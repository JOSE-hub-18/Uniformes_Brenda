...
class _BottomNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      color: const Color(0xFFD5E8FA), // Fondo azul claro de la imagen
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceAround,
        children: [
          IconButton(icon: const Icon(Icons.home_outlined, size: 32, color: Color(0xFF1452BD)), onPressed: () {}),
          IconButton(icon: const Icon(Icons.camera_alt_outlined, size: 32, color: Color(0xFF1452BD)), onPressed: () {}),
          IconButton(icon: const Icon(Icons.logout, size: 32, color: Color(0xFF1452BD)), onPressed: () {}),
        ],
      ),
    );
  }
